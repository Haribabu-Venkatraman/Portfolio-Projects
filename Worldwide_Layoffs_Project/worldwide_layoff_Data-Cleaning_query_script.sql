...
-- Populating missing data in Industry column:
...
from layoffs_staging_main a
join layoffs_staging_main b
on a.company = b.company 
and a.location = b.location
where a.industry is null
and b.industry is not null;

update layoffs_staging_main a
join layoffs_staging_main b
on a.company = b.company 
and a.location = b.location
...
-- Deleting unwanted/ unusable rows (Not Recommended):
...
-- Thats it, the World wide Layoffs dataset has been cleaned for further usage.